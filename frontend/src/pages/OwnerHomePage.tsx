  ...
  return (
    <section>
      ...
      <div className="feature-grid">
        ...
        <FeatureCard code="FR-03" title="Edit Information" description="Maintain owner profile information and secure contact details." to="/owner/profile/edit-information" icon={UserRoundCog} />
      </div>
    </section>
  );
}
